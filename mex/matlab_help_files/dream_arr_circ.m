% [H,err] = dream_arr_circ(Ro,a,G,s_par,delay,m_par,foc_met,focal,...
%     steer_met,steer_par,apod_met,apod,win_par,err_level);
%
%     DREAM_ARR_CIRC - Computes the spatial impulse response for an array
%     with circular elements using parallel processing (using threads).
%
...
%
% dream_arr_circ is a mex-function that is a part of the DREAM
