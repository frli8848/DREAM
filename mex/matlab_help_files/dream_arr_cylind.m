% [H,err] = dream_arr_cylind(Ro,geom_par,G,s_par,delay,m_par,foc_met,focal,...
%     steer_met,steer_par,apod_met,apod,win_par,err_level);
%
%     DREAM_ARR_CYLIND - Computes the spatial impulse response for an
%     array with cylindrical concave (focused) elements.  using parallel
...
%
% dream_arr_cylind is a mex-function that is a part of the DREAM
