% [H,err] = dreamcirc(Ro,geom_par,s_par,delay,m_par,err_level,device)
%
%     DREAMCIRC - Computes the spatial impulse response for a circular
...
%
% dreamcirc is a mex-function that is a part of the DREAM Toolbox
