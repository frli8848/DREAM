% [H,err] = dreamcirc_f(Ro,geom_par,s_par,delay,m_par,foc_met,focal,err_level)
%
%     DREAMCIRC_F - Computes the spatial impulse response for a circular
%     focused transducer using parallel processing (using threads).
%
...
%
%     ‘foc_met’
%          Focusing method, options are: 'off', 'x', 'y', 'xy', and
%          'x+y'.
%     ‘focal’
%          Focal distance [mm].
%
...
%
% dreamcirc_f is an mex-function that is a part of the DREAM Toolbox
