% [H,err] = dreamline(Ro,geom_par,s_par,delay,m_par,err_level)
%
%     DREAMLINE - Computes the spatial impulse response for a a line
%     (strip) transducer using parallel processing (using threads).
%
...
%
% dreamline is a mex-function that is a part of the DREAM Toolbox
