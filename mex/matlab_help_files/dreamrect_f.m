% [H,err] = dreamrect_f(Ro,geom_par,s_par,delay,m_par,foc_met,focal,err_level)
%
%     DREAMRECT_F - Computes the spatial impulse response for a
%     rectangular focused transducer using parallel processing (using
%     threads).
%
...
%
% dreamrect_f is a mex-function that is a part of the DREAM Toolbox
