% [H,err] = dreamsphere(Ro,geom_par,s_par,delay,m_par,err_level)
%
%     DREAMSPHERE - Computes the spatial impulse response for a concave
%     (focused) or convex (defocused) spherical transducer using parallel
