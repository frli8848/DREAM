...
# We cannot append column-wise as in python as in MATLAB/Octave so
...
z = np.linspace(0.0,20.0, num=int(64), endpoint=True) # Make sure its a factor of 64 (the OpenCL work group size).
