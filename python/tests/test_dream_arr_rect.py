...
# Usage:
#
# $ python run_single_element_1D.py pi_back cu_back_1 PIEZO PIEZO_type cu_front pi_front front_pad frontpad_material p_length mesh_size sim_length save_data data_folder
#
# $ python run_single_element_1D.py 50.0 5.0 110.0 "ms_pvdf" 5.0 50.0 3.0 "aqualene" 30.0 500 10.0 1 results_my_test
