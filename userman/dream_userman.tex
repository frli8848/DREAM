...
For Python, the corresponding code is:
...
transfered aand stored on the GPU since we do not transfer the \texttt{Ro}, \texttt{Gt}, and \texttt{Gr} matrices
to the GPU.
